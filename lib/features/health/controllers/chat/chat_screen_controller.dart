...
class ChatScreenController extends GetxController {
  ...
  void saveMessageToFirestore(ChatMessage message) {
    final chatCollection = firestore.collection('chat').doc(userController.user.value.id).collection('messages');
    ...
    chatCollection.add({
      ...
      'mediaUrls': message.medias?.map((media) => media.url).toList() ?? [],
    });
  }
}
