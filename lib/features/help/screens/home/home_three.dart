...
import 'package:your_health_mate/features/help/screens/your_appointments/your_appoinments.dart';
    ...
    return Obx(() {
      return DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: const YHMHomeAppBar(
            widget: Column(
              children: [
                SizedBox(height: 20),
                YHMSearchBar(),
                SizedBox(height: 20),
                YHMCategoryTabLayout(),
              ],
            ),
          ),
          body: Stack(
            children: [
              Positioned(
                child: Obx(() {
                  /// -- Loading
                  if (homeServiceController.categoryController.isLoading.value ||
                      homeServiceController.isLoading.value) {
                    return Center(
                          ...
                          Obx(() {
                            ...
                            return Column(
                              children: homeServiceController.liveServices.map((service) {
                                ...
                                int trafficTime = service['trafficTime'];
                                return YHMServiceCard(
                                  ...
                                  trafficTime: trafficTime != null ? '${trafficTime ~/ 60} mins' : 'N/A',
