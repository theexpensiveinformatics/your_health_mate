...
class YHMColors {
  // App theme colors
  static const Color primary = Color(0xFF147DF0);
  ...
  static const Color lightTest = Color(0xFFFAFAFF);
  static const Color lightBlue = Color.fromARGB(255, 206, 209, 224);
  ...
  static Color darkContainer = YHMColors.white.withOpacity(0.1);
  ...
  static const Color orange = Color(0xFFFF832F);

  static const Color shadow = Color(0xFFF8F8F8);


  ///gredient color FFFFFFF to EAEAEA

  static const Color gradientStart = Color(0xFFEAEAEA);
  static const Color gradientBlue = Color(0xFFE9EDFF);
  static const Color gradientBlueLight = Color(0xFFDFECFF);
  static const Color gradientGreen = Color(0xFFEAFFE9);
