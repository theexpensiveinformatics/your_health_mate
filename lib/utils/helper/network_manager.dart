...
class NetworkManager extends GetxController {
  ...
  /// check the internet connection status based on changes in connectivity and show a relevant popup for no internet connection.
  Future<void> _updateConnectionsStatus(ConnectivityResult result) async {
    _connectionStatus.value = result;
    if (_connectionStatus.value == ConnectivityResult.none) {
      // HHLoaders.warningSnackBar(title: 'No Internet Connection');
    }
  }
